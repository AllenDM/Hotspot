    ...
    ?>
        ...
        <section id = "info">
           <img src = "/User/misc/none.jpg" style = "height:70px;width:60px;border:2px double black;"><br><br>
            ...
            <li><a class="active" href="/User/SocialyteMatch.php">Matchbox</a></li>
            </ul>
            <br>
            ...
            <footer>
              ...
              <br>
    <div id = "box1">
    <form role = "form" action = '/User/match.php?type=1&do=create' method = 'POST' > 
        <h2 style = "color:black;"><font size = "5">Create a group</font></h2>
        <input type = "text" id = "groups" name = "groups"placeholder = "name...." >
        <input type = "submit">
        
        </form></div><br>
    <?php
   echo '<iframe src="/User/matchbox.php?id='.$user["User ID"].'" style = "width:240px;height:300px;" sandbox></iframe>';
       ?>
</body>
    <script>
    </script>
