...
#nava {
    ...
    <li id = "user"><a id= "navl5"href = "/User/Socialyte.php"><img src ="/User/misc/Socialyte.png"></a></li>
      ...
      <ul id = "actnav">
        <nav id = "anav">
            <li id = "nav1" ><a  id= "nava"href = "/User/activity.php">Activity</a></li>
            <li id = "nav1"><a class = "active" id= "nava"href = "/User/MEactivity.php">My Events</a></li>
        </nav>         
          </ul><br><br>
    <div class="container"> 
  ...
  <?php
   ...
   //echo "Connection to database successfully";
        ...
        $cursor = $collection->find(array("type" => "MyEvents","recipient"=> $_SESSION["username"] ));
        foreach($cursor as $announce){
        $event = $collection->findone(array('_id'=> new MongoID($announce["pertaining"])));
      echo '<tr><td><a href = "/User/eventview.php?name='.$announce["pertaining"].'"><font color = "black">'.$announce["message"].'</a></td></tr>';
        }
        ?>
