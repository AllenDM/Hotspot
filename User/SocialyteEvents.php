...
$user = $collection->findone(array('_id' => $_SESSION["loggedInUser"])); 
    ...
    ?>
        ...
        <section id = "info">
           <img src = "/User/misc/none.jpg" style = "height:70px;width:60px;border:2px double black;"><br><br>
            <ul id = "infotab">
            <li ><a href="/User/Socialyte.php">Main</a></li>
            <li><a class="active" href="/User/SocialyteEvents.php">Events</a></li>
            <li><a  href="/User/SocialyteMatch.php">Matchbox</a></li>
            </ul>
  ...
  // echo "Connection to database successfully";
   ...
   //echo "Collection selected succsessfully";
	$cursor = $eventcollection->find(array('event organizer' => $_SESSION["username"]));
    $cursor->sort(array('created time' => -1));
   foreach ($cursor as $document) { 
      echo '<tr><td><a href = "/User/eventview.php?name='.$document["_id"].'&user='.$document["event organizer"].'" style = "text-decoration: none;"><font color = "black" size = "4">'.$document["name"].'</font></a></td></tr>';
   }
?>
      </tbody>
  </table>
