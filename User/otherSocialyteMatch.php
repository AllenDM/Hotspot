    ...
    ?>
       ...
       <section id = "info">
         <img src = "/User/misc/none.jpg" style = "height:70px;width:60px;border:2px double black;"><br><br>
          ...
          <li><a href="/User/otherSocialyteEvents.php?name=<?php echo $user["User ID"] ?>">Events</a></li>
           <li><a class="active" href="/User/otherSocialyteMatch.php?name=<?php echo $user["User ID"] ?>">Matchbox</a></li>
           </ul>
          <br>
       ...
       <br>
     <?php
   echo '<iframe src="/User/othermatchbox.php?id='.$user["User ID"].'" style = "width:200px;height:300px;" sandbox></iframe>';
            ?>
</body>
    <script>
    </script>
